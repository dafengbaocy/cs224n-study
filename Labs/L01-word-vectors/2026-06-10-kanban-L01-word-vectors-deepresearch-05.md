...
- waypoint: `WP05 - Pretrained Vectors / Analogy / Visualization`
- official anchor: `slides p9 plan item 'Looking at word vectors'; A1 Part 2; R02 compositionality/analogy evidence`
- research question: `How do pretrained vector analogies and compositional relationships work geometrically, when do they fail, how should cosine/PCA/t-SNE visualizations be interpreted, and what bias/failure cases should be surfaced before A1 Part 2?`（必须是当前 waypoint 的具体卡点，不能只写泛化主题）
       ...
       "items": [
         {
           ...
           "used_for": ["WP05 - Pretrained Vectors / Analogy / Visualization"],
           "alt": "清晰说明来源和学习用途",
